import type { Character, WorldState, ActionHistoryEntry } from "$lib/types/character";
import { fetchGameData, type GameData, gameDataService } from "$lib/services/gameDataService";
